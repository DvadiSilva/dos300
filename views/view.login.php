<?php
    require("layouts/view.headerSimple.php");
?>
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-sm-6 text-black">
        ...
        <div class="d-flex align-items-center h-custom-2 px-5 ms-xl-4 mt-5 pt-5 pt-xl-0 mt-xl-n5">
          ...
          <form style="width: 23rem;" action="/login" method="post">
            ...
            <div class="pt-1 mb-4">
              <button class="btn border border-dark my-button-2" type="submit" name="send">Login</button>
            </div>

            <p>Ainda não tem conta? <a href="/register" class="btn-link">Crie uma aqui</a></p>
      ...
      <div class="col-sm-6 px-0 d-flex justify-content-center align-items-center">
        <img src="/images/random/300_logo_clean.png"
